import { inputObjectType, extendType, nonNull, stringArg, intArg } from "nexus";
    ...
    definition(t) {
        ...
        t.field("updateActivity", {
            ...
            resolve(_parent, args, ctx) {
                ...
                return ctx.db.activity.update({ where: { id: args.id }, data: activity });
            }
        });
    ...
    definition(t) {
        ...
        t.field("updateChallenge", {
            ...
            resolve(_parent, args, ctx) {
                ...
                return ctx.db.challenge.update({ where: { id: args.id }, data: challenge });
            }
        });
